...
let totalTime = brushTeeth + uploadPhotos + chooseClothes + shower + goGym + finishHomework + readQuran + duolingoApp
/*:
 ...
 */
 let thingsYouHaveToDo = brushTeeth + goGym + duolingoApp + readQuran

let thingsYouLikeToDo = goGym + duolingoApp + readQuran + uploadPhotos + finishHomework

let thingsYouDislikeToDo = uploadPhotos + shower + brushTeeth
/*:
