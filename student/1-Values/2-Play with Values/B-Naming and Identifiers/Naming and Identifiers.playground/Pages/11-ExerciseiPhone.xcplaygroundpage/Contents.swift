 ...
 */
//in GB
let iPhoneStorageCapacity = 8

let storageOccupiedAlready = 3

let freeStorageAvailable = iPhoneStorageCapacity - storageOccupiedAlready

let gigabyteInMegabytes = 1000

let oneMinuteVideoStorage = 150

let totalStorageOfVideo = freeStorageAvailable * gigabyteInMegabytes * oneMinuteVideoStorage

let totalMinutesOfVideo = totalStorageOfVideo / oneMinuteVideoStorage

//Therefore, it takes 5000 minutes of Video to fill 8gb storage iPhone.
